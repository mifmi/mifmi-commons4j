		...
		assertMapEquals(new LinkedHashMap<String, Object>(){
			{
				put("map.string", "テスト");
				put("map.int", "12345");
				put("map.long", "123456789012345");
				put("map.double", "12345.6789");
				put("map.boolean", "true");
				put("map.datetime", "2000-01-23T01:23:45.678901234+09:00");
				put("map.date", "2000-01-23");
				put("map.time", "01:23:45.678901234+09:00");
				put("map.binary", "0123456789ABCDEF");
				put("map.array", "ふー,ばー,ばず\\,:\\\\ほげ");
			}
		}, mapVal);
	}

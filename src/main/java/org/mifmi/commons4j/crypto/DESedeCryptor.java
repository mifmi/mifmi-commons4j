...
public class DESedeCryptor extends SecretKeyCryptor {
	
	private static final String ALGORITHM = "DESede";

	public DESedeCryptor(byte[] key, String mode, String padding) {
		this(key, mode, padding, null);
	}
	
	public DESedeCryptor(byte[] key, String mode, String padding, byte[] iv) {
